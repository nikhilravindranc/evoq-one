    ...
    <section className="bg-white">
      <div className="px-5 sm:px-6 lg:px-6">
        <div className="mx-auto max-w-[1300px] py-10 lg:py-16">
          <div className="relative grid overflow-hidden rounded-[28px] bg-gradient-to-br from-white via-[#F4F9FD] to-[#EAF6F7] ring-1 ring-[#31465A]/8 lg:grid-cols-2">
            ...
            <div className="pointer-events-none absolute inset-y-8 left-1/2 hidden w-px bg-[#31465A]/10 lg:block" />

            {/* ---------- left half: shared context ---------- */}
            <div className="relative overflow-hidden px-6 py-10 sm:px-10 lg:px-12 lg:py-12">
              ...
              <Script lines={["Informed", "Teams", "Happier", "Patients"]} className="absolute right-5 top-[215px] hidden lg:block" />

              <div className="mt-6 max-w-[440px] text-[15.5px] leading-[1.6] text-[#31465A]/75">
                <p>Patients should not have to repeat their story every time they speak with someone new.</p>
                <p className="mt-4">
                  With patient profiles, interaction history, communication records, notes, activities, and
                  relationship details connected in one place, teams can understand the conversation before they
                  respond.
                </p>
                <p className="mt-4">
                  From front desk and patient relationship teams to managers and healthcare providers, everyone can
                  work from the same relationship context.
                </p>
              </div>

              <div className="relative mt-8 lg:min-h-[560px]">
                {/* doctor photo */}
                <div className="relative mt-2 h-[340px] overflow-hidden rounded-2xl lg:absolute lg:-right-12 lg:-top-2 lg:mt-0 lg:h-[440px] lg:w-[430px] lg:rounded-none">
                  <Image
                ...
                {/* roles */}
                <ul className="relative z-10 mt-8 flex flex-col gap-6 lg:mt-0 lg:w-[250px]">
                  {ROLES.map((r) => (
                ...
                <div className="relative z-10 mt-8 rounded-[18px] bg-white p-4 shadow-[0_28px_60px_-28px_rgba(16,42,67,0.4)] ring-1 ring-[#31465A]/5 lg:absolute lg:-right-6 lg:bottom-0 lg:mt-0 lg:w-[310px]">
              ...
              <a
                href="#features"
                className="relative z-10 mt-8 inline-flex items-center gap-3 rounded-full bg-[#2064B6] px-7 py-3.5 text-[15.5px] font-semibold text-white no-underline shadow-[0_14px_30px_-14px_rgba(32,100,182,0.6)] transition-all hover:-translate-y-px hover:bg-[#1A559C] lg:mt-6"
              >
            ...
            {/* ---------- right half: enquiry to relationship ---------- */}
            <div className="relative px-6 py-10 sm:px-10 lg:px-12 lg:py-12">
              ...
              <div className="mt-6 max-w-[560px] text-[15.5px] leading-[1.6] text-[#31465A]/75">
                <p>
              ...
              {/* enquiries dashboard */}
              <div className="mt-8 rounded-[18px] bg-white p-5 shadow-[0_24px_54px_-30px_rgba(16,42,67,0.3)] ring-1 ring-[#31465A]/5">
              ...
              <div className="mt-6 flex flex-wrap items-end justify-between gap-6">
                ...
                <Script lines={["More Enquiries", "More Appointments", "Stronger Relationships"]} className="hidden pr-2 lg:block" />
              </div>
            </div>
          </div>
        </div>
